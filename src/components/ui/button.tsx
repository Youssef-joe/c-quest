  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        magic: "bg-gradient-to-r from-primary via-amber-400 to-accent text-primary-foreground hover:opacity-90 shadow-lg shadow-primary/40 animate-pulse",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-lg shadow-success/30",
        wizard: "bg-gradient-to-r from-secondary to-purple-600 text-secondary-foreground hover:from-purple-600 hover:to-secondary border border-primary/30",
      },
      size: {
